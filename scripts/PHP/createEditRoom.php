				...
				<div class="row">
					...
					<div class="col-xl-3" >
							<button class="btn btn-secondary" style="margin-top: 55px; margin-left: 50px; <?php echo ($roomToEdit['limit'] == 1) ? "display: run-in" : "display: none"?>" 
								id="addUser" name="addUser" type="button" onclick="saveChanges(); openConfirmCreateUser(document.getElementById('allowedUser').value, document.getElementById('roomid').value)" >Add User</button>
					</div>
