				...
				<div class="row">
					...
					<div class="col-xl-3" >
							<button class="btn btn-secondary" style="margin-top: 55px; margin-left: 50px; <?php echo ($roomToEdit['limit'] == 1) ? "display: run-in" : "display: none"?>" 
								...
								onclick="openConfirmAddUser(document.getElementById('allowedUser').value, document.getElementById('roomid').value, <?php echo(json_encode($beingEdited)); ?>)" >Add User</button>
					</div>
