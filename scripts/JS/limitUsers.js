...
function openConfirmCreateUser(name)
{
	...
	showMessageBox("<br><br>Are you sure you want to add:<br><br>" + name +  "<br> <br><button class = 'modal-button btn btn-success' id='yesDelete' onclick='insertUserWhitelist()'>Yesssssssssssssssssssssssssssssssssssssssssss</button> <button class='modal-button btn btn-danger' id='noDelete' onclick='closeModal()'>No</button>", "Delete Reservation", "", false);
