...
-- Dumping data for table cs455.blacklist: ~1 rows (approximately)
...
-- Dumping data for table cs455.favorites: ~8 rows (approximately)
...
-- Dumping data for table cs455.reservations: ~47 rows (approximately)
...
INSERT INTO `reservations` (`roomnumber`, `owneremail`, `allowshare`, `headcount`, `startdate`, `enddate`, `starttime`, `endtime`, `occur`, `comment`, `id`, `res_email`) VALUES
	...
	('Keller 122', 'super@una.edu', 0, '', '2018-05-17', '2018-05-17', '12:00:00', '13:00:00', 'Once', '', 131, 'super@una.edu'),
	('Keller 122', 'super@una.edu', 0, '', '2018-05-24', '2018-05-24', '15:00:00', '16:00:00', 'Once', '', 132, 'super@una.edu'),
	('Keller 122', 'super@una.edu', 0, '', '2018-06-04', '2018-06-04', '12:00:00', '13:00:00', 'Once', '', 133, 'super@una.edu'),
	('Keller 333', 'super@una.edu', 0, '', '2018-06-07', '2018-06-07', '13:00:00', '14:00:00', 'Once', '', 134, 'super@una.edu'),
	('Keller 122', 'super@una.edu', 0, '', '2018-06-08', '2018-06-08', '14:00:00', '15:00:00', 'Once', '', 135, 'super@una.edu'),
	('Keller 220', 'super@una.edu', 0, '', '2018-06-14', '2018-06-14', '08:00:00', '08:45:00', 'Once', '', 136, 'super@una.edu'),
	('Keller 122', 'super@una.edu', 0, '', '2018-07-28', '2018-07-28', '08:00:00', '21:00:00', 'Once', '', 137, 'super@una.edu'),
	('Keller 122', 'super@una.edu', 0, '', '2018-07-28', '2018-07-28', '21:30:00', '23:00:00', 'Once', '', 138, 'super@una.edu'),
	('Keller 122', 'super@una.edu', 0, '', '2018-07-31', '2018-07-31', '12:00:00', '14:00:00', 'Once', '', 140, 'super@una.edu'),
	('Keller 220', 'super@una.edu', 0, '', '2018-08-01', '2018-08-01', '08:00:00', '13:00:00', 'Once', '', 141, 'super@una.edu'),
	('Keller 122', 'super', 0, '', '2018-08-16', '2018-08-16', '08:00:00', '09:00:00', 'null', 'super', 142, 'super@una.edu');
...
INSERT INTO `rooms` (`roomid`, `type`, `floor`, `seats`, `hascomputers`, `numcomputers`, `numeric_id`) VALUES
	...
	('Keller 333', 'Classroom', 3, 48, 0, 0, 9),
	('Keller 221', 'Conference Room', 2, 10, 0, NULL, 10),
	('Keller 233', 'Computer Lab', 2, 58, 1, 58, 11),
	('Keller 234', 'Classroom', 2, 24, 0, NULL, 12),
...
-- Dumping data for table cs455.users: ~9 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`email`, `firstname`, `lastname`, `password`, `classification`, `groupID`) VALUES
	('1', '1', '1', '17ba0791499db908433b80f37c5fbc89b870084b', 'ADMIN', 2),
	('2', '2', '2', '12c6fc06c99a462375eeb3f43dfd832b08ca9e17', 'USER', 2),
	('3', '3', '3', 'b6692ea5df920cad691c20319a6fffd7a4a766b8', 'ADMIN', 2),
	('4', '4', '4', '98fbc42faedc02492397cb5962ea3a3ffc0a9243', 'USER', 2),
	('admin@una.edu', 'admin', 'admin', '771fd8b75bddc7a94885ec0331bf0f3c298dc2ae', 'ADMIN', 2),
	('fglover@una.edu', 'Franklin', 'Glover', 'cdc4242074a4d84790e1b6d2fe254b2c562d187d', 'ADMIN', 2),
